...
export class RdsStack extends cdk.Stack {
  constructor(scope: cdk.App, id: string, props?: cdk.StackProps) {
    ...
    const cluster = rds.ServerlessCluster.fromServerlessClusterAttributes (this, "serverlessCluster", {
      clusterIdentifier: "database-1",
      //clusterEndpointAddress: "database-1.cluster-crfohsmyvulz.us-east-1.rds.amazonaws.com",
    })
    ...
    const ReadIOPSmetric = new cloudwatch.Metric({
      ...
      metricName: 'ReadIOPS',
      dimensionsMap: {
        DBInstanceIdentifier: cluster.clusterIdentifier[1]
      }
    });
    ...
    const WriteIOPSmetric = new cloudwatch.Metric({
      ...
      dimensionsMap: {
        DBInstanceIdentifier: cluster.clusterIdentifier[0]
      }
    });
